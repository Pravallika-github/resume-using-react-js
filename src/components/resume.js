      ...
      <div className="res">
        <Grid>
          <Cell col={4}>
            ...
            <hr/>
            <h6 style={{color:'#131313',fontFamily:'Jokerman'}}>CAREER OBJECTIVE:</h6>
           ...
           <hr/>
            <h6 style={{color:'#131313',fontFamily:'Jokerman'}}>ADDRESS:</h6>
            <p style={{color: '#5100FC',fontSize:'24px',fontFamily:'Lucida Handwriting'}} >visakhapatnam</p>
             <hr/>
            <h6 style={{color:'#131313',fontFamily:'Jokerman'}}>Phone</h6>
            <h2 style={{color: '#5100FC',fontSize:'24px',fontFamily:'Lucida Handwriting'}} >+9396548726</h2>
            <hr/>
            <h6 style={{color:'#131313',fontFamily:'Jokerman'}}>Email-id</h6>
            <h6 style={{color: '#5100FC',fontSize:'24px',fontFamily:'Lucida Handwriting'}} >pravallikasanapala1@example.com</h6>
